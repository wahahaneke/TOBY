        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-toby-darkbg rounded-lg overflow-hidden">
            <div className="relative aspect-square">
              <Image
                src="/images/rs=w_1160,h_1163.webp"
                alt="Toby with headphones and sunglasses"
                fill
                className="object-cover"
              />
            </div>
            <div className="p-6">
              <h3 className="text-white font-archivo text-xl mb-3 text-center">
                Toby&apos;s Story
              </h3>
              <div className="mb-4">
                <p className="text-white font-semibold font-montserrat mb-2 text-center">
          ...
          <div className="bg-toby-darkbg rounded-lg overflow-hidden">
            <div className="relative aspect-square">
              <Image
                src="/images/rs=w_1160,h_1163 (1).webp"
                alt="Toby Navy SEAL"
                fill
                className="object-cover"
              />
          ...
          <div className="bg-toby-darkbg rounded-lg overflow-hidden">
            <div className="relative aspect-square">
              <Image
                src="/images/qt=q_29.webp"
                alt="Toby Matrix style"
                fill
                className="object-cover"
              />
            </div>
